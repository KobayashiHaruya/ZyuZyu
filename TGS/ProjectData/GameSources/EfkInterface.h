...
namespace basecross {
	...
	public:
		...
		*/
		//--------------------------------------------------------------------------------------
		void Play(const shared_ptr<EfkEffect>& effect, const bsm::Vec3& Emitter);

		void Play(const shared_ptr<EfkEffect>& effect, const bsm::Vec3& Emitter, const int32_t startFrame);
		//--------------------------------------------------------------------------------------
		/*!
		@brief	エフェクトをストップさせる
		@return	なし
