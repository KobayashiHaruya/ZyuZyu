...
int MainLoop(HINSTANCE hInstance, HWND hWnd, bool isFullScreen, int iClientWidth, int iClientHeight) {
	...
	try {
		...
		//キーボード入力用
		//ここに設定したキーボード入力を得る
		vector<DWORD> UseKeyVec = { 'Q','W','E','R','A','S','D','F','G','Z','X','C','V','P',VK_SPACE,VK_SHIFT,VK_LSHIFT,VK_RSHIFT,VK_CONTROL,VK_RIGHT,VK_LEFT,VK_UP,VK_DOWN,VK_LBUTTON,VK_RBUTTON };
